    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown" aria-haspopup="true"
                    ...
                    <?php } ?>
                    <?php if ($lang == 'fa') { ?>
                        <img class="me-2" src="assets/images/flags/iran.jpg" alt="Header Language" height="16"> 
                    <?php } ?>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <!-- item-->
                    <a href="?lang=fa" class="dropdown-item notify-item language">
                        <img src="assets/images/flags/iran.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> Persian </span>
                    </a>
                </div>
            </div>
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="assets/images/users/avatar-1.jpg"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium"><?php echo $_SESSION["user_full_name"]; ?>.</span>
